...
class CreateJson {
    ...
    public JSONObject typeImage() throws JSONException {
        ...
        objectImage.put("src", "http://localhost:8080/Servidor/app/descarga/image");
    ...
    public String create(String path) throws IOException, JSONException {
        ...
        JSONObject objectImage = typeImage();
        JSONObject objectRect = new JSONObject();
        ...
        json.put("data-uri", encodeToString(image, "jpeg"));
